...
let getBranchHead;
{
    ...
    getBranchHead = (branch) => __awaiter(void 0, void 0, void 0, function* () {
        if (!refs) {
...
function formatJiraLinks(tickets) {
    if (tickets.length === 0)
        return '';
...
function createBranch(name, fromBranch) {
    return __awaiter(this, void 0, void 0, function* () {
        const body = {
            ref: `refs/heads/${name}`,
            sha: yield getBranchHead(fromBranch)
        };
...
function noDiff(fromBranch, toBranch) {
    return __awaiter(this, void 0, void 0, function* () {
        const from = yield getBranchHead(fromBranch);
        const to = yield getBranchHead(toBranch);
        return from === to;
    });
}
function createAutoPR() {
    return __awaiter(this, void 0, void 0, function* () {
        if (yield noDiff(fromBranch, toBranch)) {
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(9990);
